...
```
paper-search ──清單/BibTeX──▶ source-document-extraction ──extracted/*.md──▶ 閱讀/分析/審查層 ──▶ literature-review-organizer
 (發現)                        (PDF→結構化 Markdown)          │ paper-reading-zh              (多篇綜整/SR)
...
| `reports/` | 各 skill 的書面報告成果（markdown） | 所有閱讀/分析/審查 skill | 使用者 |
